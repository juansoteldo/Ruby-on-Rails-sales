class BoxMailer < ActionMailer::Base
  ...
  def reminder_email(email)
    mail(to: email, bcc: 'sales@customtattoodesign.ca, KaylaMckee@customtattoodesign.ca', subject: 'Lee Roller Owner / Custom Tattoo Design', from: 'leeroller@customtattoodesign.ca')
  end
