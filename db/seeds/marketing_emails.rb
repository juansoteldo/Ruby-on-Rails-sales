MarketingEmail.create( state: 'fresh,quoted', days_after_state_change: 1,
                       ...
                       template_name: '24_hour_reminder_email', template_path: 'box_mailer/lead_reminders', version: 1 )
...
MarketingEmail.create( state: 'fresh,quoted', days_after_state_change: 7,
                       ...
                       template_name: '1_week_reminder_email', template_path: 'box_mailer/lead_reminders', version: 1 )
...
MarketingEmail.create( state: 'fresh,quoted', days_after_state_change: 14,
                       ...
                       template_name: '2_week_reminder_email', template_path: 'box_mailer/lead_reminders', version: 1 )
...
MarketingEmail.create( state: 'deposited,completed', days_after_state_change: 2,
                       ...
                       template_name: '48_hour_follow_up_email', template_path: 'box_mailer/customer_follow_ups', version: 1 )
...
MarketingEmail.create( state: 'deposited,completed', days_after_state_change: 14,
                       ...
                       template_name: '2_week_follow_up_email', template_path: 'box_mailer/customer_follow_ups', version: 1 )
